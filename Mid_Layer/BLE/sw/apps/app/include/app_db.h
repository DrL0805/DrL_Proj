...
typedef struct
{
    void (*ReadRecInfo)(appDbRec_t *pRecord);
    int32_t (*StoreRecInfo)(appDbHdl_t hdl);
}ble_db_info_f;
...
extern void AppDbSetFun(ble_db_info_f *dbfun);

void AppDbClear(void);

//设置DB回调函数
extern void AppDbFunInit(void);
